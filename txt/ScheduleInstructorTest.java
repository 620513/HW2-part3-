...
public class ScheduleInstructorTest {
    ...
    public void addTest(){
        ...
        Assert.assertFalse(courses.contains(c1));
        Assert.assertFalse(courses.contains(c2));
    ...
    public void addNegativeTest(){
        ...
        Course c5 = buildCourseHelper("EGR 107,1,WF,02:00 AM,121");
...
//        Assert.assertFalse(courses.contains(c3));
    ...
    public void getCourseTest(){
        ...
        Schedule s = buildScheduleHelper(courseStrings);
        Course c1 = s.getCourse(Weekday.WEDNESDAY, new Time (5, 00, true));
        ...
        Assert.assertTrue(c3.toString().equals(c4.toString()));
    ...
    public void removeTest(){
        ...
        Assert.assertFalse(s.getAllCourses().contains(c2));
    }
